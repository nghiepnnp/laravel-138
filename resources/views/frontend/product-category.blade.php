...
@section('content')
  ...
  <div class="pt-3" style="width:90%;margin:auto">
    <img src="{{asset('images/banner-bot.jpg')}}" class="img-fluid" width="1400">
  </div>
  ...
  <div class="row">
    ...
    <div class="col-2 mt-3">
      <ul class="list-group border">
        ...
        <a href="{{url('san-pham/'.$cat->slug)}}">
          <li class="list-group-item border-0">{{$cat->name}} </li>
        </a>
        @endforeach
      </ul>
    </div>
    ...
    <div class="col-10 m-0">
      <div class="container-products mt-3 p- w-100"> 
        <div class="h4 text-white bg-danger pl-5 py-2 m-0">SẢN PHẨM THEO LOẠI</div>
        <ul class="p-0">
          @foreach ($list as $ro)
          <li>  
            <div class="card pt-3" id="xahangton" >
              <a href="{{url($ro->slug)}}">
                ...
                <div class="card-body  " >
                  <p class="card-title font-weight-bold" style="color:#525252">{{$ro->name}}</p>
