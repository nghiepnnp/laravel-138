 ...
 <div class="container text-right pt-3 pb-5 pl-5">
 	...
 	<div style="float:right">
 		<button class="btn btn-primary btn-sm px-5 py-2"><a href="{{route('topic_index')}}" class="text-light"><i class="fa fa-upload"></i> Upload</a></button>
 ...
 <form style="width:90%;margin:0 auto" method="post" action="{{route('topic_postupdate',['id'=>$row->id])}}">
 	@csrf
 	<fieldset>
 		...
 		<div class="form-group">
 			...
 			name="name"  value="{{old('name', $row->name)}}">
 		</div>
