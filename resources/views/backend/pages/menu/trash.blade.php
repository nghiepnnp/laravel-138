		...
		<div class="col-3">
			<div class="float-right">
				<button type="button" class="btn btn-primary">
					<a href="{{route('menu_index')}}" class="text-white">Index</a>
				</button>
...
<table id="example" class="display table" width="100%" data-page-length="10">
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">{{$l->parent}}</td>
			<td>{{$l->created_at}}</td>
			<td class="text-center">
				<a href="{{route('menu_retrash',['id' => $l->id])}}" class="btn btn-primary btn-sm">
					<i class="fa fa-undo py-1"></i>
				</a>
			</td>
			<td class="text-center">
				<a href="{{route('menu_delete',['id' => $l->id])}}" class="btn btn-danger btn-sm">
