...
<div class="container text-right pt-3 pb-5 pl-5">
	...
	<div style="float:right">
		<button class="btn btn-primary btn-sm px-5 py-2"><a href="" class="text-light"><i class="fa fa-upload"></i> </a></button>
...
<form style="width:90%;margin:0 auto" name="frmadd" method="post" action="{{route('user_postupdate',['id'=>$row->id])}}" enctype="multipart/form-data">
	@csrf
	<fieldset>
		...
		<div class="form-group">
			...
			<input type="password" class="form-control"  name="repass" value="{{$row->password}}">
		</div>
