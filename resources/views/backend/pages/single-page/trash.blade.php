...
<div class="clearfix py-3">
	<div class="row bg- border ">
		<div class="col-9 h4 text-danger">
			DANH SÁCH RÁC CHỦ ĐỀ
		</div>
		<div class="col-3">
			<div class="float-right">	<button type="button" class="btn btn-danger">
					<a href="{{route('singlepage_index')}}" class="text-white">Index</a>
				</button>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				<a href="{{route('singlepage_retrash',['id' => $l->id])}}" class="btn btn-primary btn-sm">
					<i class="fas fa-undo-alt"></i>
				</a>
			</td>
			<td class="text-center">
				<a href="{{route('singlepage_delete',['id' => $l->id])}}" class="btn btn-danger btn-sm">
