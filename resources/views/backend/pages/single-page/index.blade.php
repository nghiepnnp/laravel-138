	...
	<div class="row bg- border ">
		...
		<div class="col-3">
			<div class="float-right">	<button type="button" class="btn btn-danger">
					<a href="{{route('singlepage_getinsert')}}" class="text-white">Thêm</a>
				</button>
				<button type="button" class="btn btn-danger">
					<a href="{{route('singlepage_trash')}}" class="text-white">Trash</a>
				</button>
			</div>
		</div>
	</div>
...
<table id="example" class="display table" width="100%" data-page-length="10">
	<thead>
		<tr>
			...
			<th style="width:50px" class="text-center">Tên Page</th>						
			<th style="width:50px" class="text-center">Nội dung</th>						
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				@if ($l->status==1)
				<a href="{{route('singlepage_status',['id' => $l->id])}}" class="btn">
			...
			<td class="text-center">
				<a href="{{route('singlepage_getupdate',['id' => $l->id])}}" class="btn btn-primary btn-sm">
					<i class="fa fa-pen py-1"></i>
				</a>
			</td>
			<td class="text-center">
				<a href="{{route('singlepage_deltrash',['id' => $l->id])}}" class="btn btn-danger btn-sm">
