	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				@if ($l->status==1)
				<a href="{{route('post_status',['id' => $l->id])}}" class="btn">
			...
			<td class="text-center">
				<a href="{{route('post_getupdate',['id' => $l->id])}}" class="btn btn-primary btn-sm">
					<i class="fa fa-pen py-1"></i>
				</a>
			</td>
			<td class="text-center">
				<a href="{{route('post_deltrash',['id' => $l->id])}}" class="btn btn-danger btn-sm">
