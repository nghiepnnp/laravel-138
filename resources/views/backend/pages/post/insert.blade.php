...
<form  method="POST"  action="{{route('post_postinsert')}}" style="width:90%;margin:0 auto" enctype="multipart/form-data">
	@csrf
	<fieldset>
		@includeIf('backend.modules.message')
		<div class="form-group">
			<label for="formGroupExampleInput">Tiêu đề bài viết</label>
			<input type="text" class="form-control w-100" placeholder="Title ... " name="title"  value="{{old('title')}}">
		</div>
		<div class="form-group">
			<label for="formGroupExampleInput">Mô tả bài viết</label>
			<input type="text" class="form-control w-100" placeholder="Short Description ... " name="short"  value="{{old('short_description')}}">
		</div>
		<div class="form-group">
			<div class="mb-2">
